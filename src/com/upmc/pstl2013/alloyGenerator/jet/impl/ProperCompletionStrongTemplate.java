...
public class ProperCompletionStrongTemplate implements IJetTemplate {

  protected static String nl;
  public static synchronized ProperCompletionStrongTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    ProperCompletionStrongTemplate result = new ProperCompletionStrongTemplate();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_6 = NL + "check {";
	...
	public String generate(Object argument) throws JetException
  {
	...
	final Logger log = Logger.getLogger(ProperCompletionStrongTemplate.class);
