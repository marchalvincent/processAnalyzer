...
public class OptionToCompleteStrongTemplate implements IJetTemplate {

  protected static String nl;
  public static synchronized OptionToCompleteStrongTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    OptionToCompleteStrongTemplate result = new OptionToCompleteStrongTemplate();
    nl = null;
    return result;
  }
	...
	public String generate(Object argument) throws JetException
  {
	...
	final Logger log = Logger.getLogger(OptionToCompleteStrongTemplate.class);
